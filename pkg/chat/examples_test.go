...
func (m *mockTextualMemory) Get(ctx context.Context, id string) (types.MemoryItem, error) { return nil, nil }
...
func (m *mockTextualMemory) Update(ctx context.Context, id string, memory types.MemoryItem) error { return nil }
